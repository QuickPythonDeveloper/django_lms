...
class Progress(models.Model):
    ...
    def update_score(self, question, score_to_add=0, possible_to_add=0):
        ...
        if any([item is False for item in
                [score_to_add, possible_to_add, isinstance(score_to_add, int), isinstance(possible_to_add, int)]]):
...
class Sitting(models.Model):
    ...
    def get_questions(self, with_answers=False):
        ...
        questions = sorted(self.quiz.question_set.filter(id__in=question_ids).select_subclasses(),
